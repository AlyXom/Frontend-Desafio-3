...
import { addToCart, addToHeart, deleteToHeart } from "../redux/slices/heartAndCart.slice";
    ...
    return (
        <div>
            ...
            <div style={{backgroundColor: "lightgrey", width: "100%", height: 400}}>
                ...
                {product ? <button onClick={() => dispatch(addToCart({...product, quantity: 2}))}>Cart</button> : undefined}
            </div>
        </div>
    )
}